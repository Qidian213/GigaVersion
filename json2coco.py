...
class labelme2coco(object):
    def __init__(self,labelme_json,save_json_path='./new.json'):
        ...
        self.images=[]
        self.categories  = [{'supercategory': 'person', 'id': 1, 'name': 'visible_body'}]
        self.annotations = []
        self.label=[]
        self.annID=1
        self.height=0
        ...
        with open(self.labelme_json,'r') as fp:
            ...
            for num, key in enumerate(data.keys()):
                ...
                for box in anns['bboxs']:
                    self.annotations.append(self.annotation(box,'visible_body',num))
                    self.annID+=1
...
labelme_json='panda_visible.json'

labelme2coco(labelme_json, 'VISIBLE_COCO.json')